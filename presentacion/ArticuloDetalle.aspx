<%@ Page Title="Detalle del Artículo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ArticuloDetalle.aspx.cs" Inherits="presentacion.ArticuloDetalle" %>
